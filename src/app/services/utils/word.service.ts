...
export class WordService {
      ...
      this.sectionInfo = {
        ...
        children: [
          ...
          this.gerarParagrafo(
            ...
            { 
              text:`${formControls?.get('contratante')?.get('razao_social')?.value ? formControls?.get('contratante')?.get('razao_social')?.value : ""}, ${formControls?.get('contratante')?.get('pessoa_juridica')?.value ? ('pessoa jurídica de ' + formControls?.get('contratante')?.get('pessoa_juridica')?.value) : ''}, inscrita no CNPJ sob o n° ${formControls?.get('contratante')?.get('cpf')?.value}, com sede na ${this.gerarEnderecoPorta(imovelDoContratante)}, representada neste ato por seu administrador ${formControls?.get('contratante')?.get('nome')?.value}, ${formControls?.get('contratante')?.get('nacionalidade')?.value}, ${formControls?.get('contratante')?.get('estadoCivil')?.value}, ${formControls?.get('contratante')?.get('profissao')?.value}, ${formControls?.get('contratante')?.get('cpf_socio')?.value ? ("inscrito no CPF " + formControls?.get('contratante')?.get('cpf_socio')?.value + " e ") : ''}no RG sob o n° ${formControls?.get('contratante')?.get('rg')?.value}, doravante denominado `,
              size:25, 
              font: "Arial",
              outlineLevel: 2,
            },
  ...
  async generateWordContratoFile(formControls: FormGroup,  imovelDoContratante: any, parcelamentoInfo: any, type = "CONTRATO") {
    if(type == "CONTRATO") {
      await this.generateSectionInfo(formControls?.get('contratante')?.get('cpf')?.value, formControls,  imovelDoContratante, parcelamentoInfo);
    }
